	...
	return (
		<div className="w-screen h-screen h-min-[100vh]">
			...
			<div className="w-screen h-screen min-h-screen flex flex-col justify-between relative -top-[100vh] bg-transparent">
				<div id="title" className="flex flex-row justify-center text-saffron-topbar items-center topbar h-1/6 md:w-[800px] md:self-center pt-10">
				...
				<div className="h-5/6 flex flex-col justify-between">
					<div id="mama" className="flex flex-row justify-center h-3/6 items-center">
						<div className="image h-[200px] w-[200px]"></div>
					</div>
					<div id="contact" className="h-2/6 mb-20 w-full md:max-w-[500px] sm:md:max-w-[300px] md:self-center sm:md:self-center">
